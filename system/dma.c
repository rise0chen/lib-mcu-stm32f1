...
Return: void
*************************************************/
void dma_reset(DMA_Channel_TypeDef* ch){
...
Return: void
*************************************************/
void dma_configTx(DMA_Channel_TypeDef* ch, uint32_t cpar, uint32_t cmar, uint16_t cndtr){
	ch->CMAR = cmar;//内存基址
	ch->CPAR = cpar;//外设基址
...
Return: void
*************************************************/
void dma_configRx(DMA_Channel_TypeDef* ch, uint32_t cpar, uint32_t cmar, uint16_t cndtr){
	ch->CMAR = cmar;//内存基址
	ch->CPAR = cpar;//外设基址
	ch->CNDTR= cndtr;//DMA缓存大小
...
Return: void
*************************************************/
void dma_configADC(uint32_t cmar, uint8_t cndtr){
