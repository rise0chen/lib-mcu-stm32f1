...
Return: void
*************************************************/
void dma_configTx(DMA_Channel_TypeDef* ch, u32 cpar, u32 cmar, u16 cndtr){
	ch->CMAR = cmar;//内存基址
	ch->CPAR = cpar;//外设基址
...
Return: void
*************************************************/
void dma_configRx(DMA_Channel_TypeDef* ch, u32 cpar, u32 cmar, u16 cndtr){
	ch->CMAR = cmar;//内存基址
	ch->CPAR = cpar;//外设基址
	ch->CNDTR= cndtr;//DMA缓存大小
...
Return: void
*************************************************/
void dma_configADC(u32 cmar, u8 cndtr){
